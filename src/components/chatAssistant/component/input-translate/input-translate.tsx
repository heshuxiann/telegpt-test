      ...
      >
        <div className="bg-[var(--color-background)] w-[375px]">
          ...
          <div className="py-[20px] px-[24px] border-[var(--color-background-secondary)] border-t-[1px] border-b-[1px]">
            <div className="w-full bg-[#EFF6FF] border-[1px] border-[#BEDBFF] rounded-[12px] py-[12px] px-[16px] flex gap-[12px]">
              <Icon name="clock" style={buildStyle('color:#007AFF;margin-top:4px;')} />
              <div>
                <div>AI Detected Language</div>
                {detectedLanguageName ? (
                  <div className="text-[14px]">
                    <span className="text-[#4A5565]">This conversation is in </span>
                    <span className="text-[#007AFF] font-bold">{detectedLanguageName}</span>
                  </div>
                ) : (
                  <div className="text-[14px]">
                    <span className="text-[#4A5565]">No language detected in this chat.</span>
                  </div>
                )}
            ...
            <div className="w-full bg-[#F9FAFB] rounded-[12px] py-[12px] px-[16px] flex gap-[12px] items-center">
              ...
              <div className="flex flex-col">
                <span className="text-[14px] text-[#4A5565]">Outgoing messages in</span>
                <span className="text-[16px] font-semibold text-[var(--color-text)]">{inputTranslateOptions?.translateLanguageName ?? 'English'}</span>
              </div>
              <div className="flex items-center justify-center ml-auto" onClick={openInputLanguageModal}>
                <Icon name="arrow-right" style={buildStyle('color:#007AFF;font-size:20px')} />
              </div>
            </div>
          </div>
          <div className="py-[16px] px-[24px]">
            <Button size="tiny" className="!h-[48px] w-full !bg-[#155DFC] normal-case" onClick={handleConfirm}>
              Confirm Settings
            </Button>
          </div>
        </div>
