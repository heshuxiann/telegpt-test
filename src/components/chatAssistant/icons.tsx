...
export const VoiceingIcon = ({ size = 24 }: { size?: number }) => {
  return (
    <svg
      ...
      fill="none"
    >
      <path d="M12 4V20M8 9V15M20 10V14M4 10V14M16 7V17" stroke="#4C72FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};
...
export const LanguageIcon = ({ size = 20 }: { size?: number }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M2 12C2 17.523 6.477 22 12 22C17.523 22 22 17.523 22 12C22 6.477 17.523 2 12 2C6.477 2 2 6.477 2 12Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
